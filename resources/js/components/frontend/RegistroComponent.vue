<template>
    <div>
            ...
            <div class="register-box">
                <h4 class="heading__tertiary mb--30">Registrate si sos distribuidor</h4>
                <form class="form form--login">
                    ...
                    <div class="form__group mb--20">
                        ...
                        <input type="email" class="form__input" v-model="correoElectronico" required @blur="validateEmail">
                    </div>
                    <div class="form__group mb--20">
    ...
    methods:{
        ...
        limpiar: function () {
         ...
         validateEmail: function () {
            if (!/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/.test(this.correoElectronico)) {
                Swal.fire({
                      position: 'center',
                      icon: 'danger',
                      title: 'Por favor ingrese un Correo Electronico Valido!',
                      showConfirmButton: false,
                      timer: 2500
                    })
            }
