...
<!-- Main Wrapper Start -->
<div class="wrapper">
    <div class="single-slide d-flex align-items-center bg-image" data-bg-image="assets/img/premios/beach-product-background.jpg" style=" background-position: top !important; margin-top: 0% !important;">                    
        <!-- Main Content Wrapper Start -->
        <main class="main-content-wrapper espacio-menu">
            ...
            <div class="row justify-content-center"></div>
                <center>
                    <img src="{{ asset('assets/img/premios/premios_new.png') }}" alt="Premios" style="width: 65%; max-width: 100%; max-height: 100%;" class="responsive-footer">
                </center>
                                    ...
                                    <div class="row mb--20 mb-md-33 mt--20">
                                        <div class="col-lg-12 col-md-12">
                                            <p align="justify" style="font-size: 15px !important;">
                                                El Desafío Lesaffre 2022 premiará al distribuidor que alcance la mejor posición en el concurso con un increíble viaje.
                                                ...
                                                Se  consideran las compras de distribuidores realizadas entre el 1 de Julio al 30 de Octubre de 2022. 
                                                La registración y aceptación de las bases de participación deberá realizarse en: www.lesaffreplay.com/DesafioLesaffre2022.
